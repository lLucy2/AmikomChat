...
object NewsData {
    private val title = arrayOf(
        "10 Mahasiswa Universitas Amikom Yogyakarta Menerima Beasiswa Sarjana dari Bank Mualamat Indonesia",
        "Mahasiswa Ilmu Komunikasi AMIKOM Ikuti program Youth Abroad Expedition (YAE) #4 di Malaysia",
        "Mahasiswa S1 Teknik Komputer Universitas AMIKOM Yogyakarta berhasil jadi Juara 1 dalam Lomba IoT and Networking Competition (IoNIC 2023)",
        "AMIKOM KEMBALI MENCURI PERHATIAN, 19 MEDALI DI RAIH DALAM KEJUARAAN NASIONAL TAEKWONDO GRADE-C WALI KOTA CUP X 2023.",
        "Fakultas Ilmu Komputer Bersama Prodi Sistem Informasi dan Informatika AMIKOM Jogja Raih Kemenangan Sebagai BEST INNOVATION di Innoserve 2023 Taiwan",
        "Dies Natalis ke-29 Universitas Amikom Yogyakarta Hadirkan Program Doktoral (S3) Informatika",
        "Grand Launching Dies Natalis ke-29 universitas Amikom Yogyakarta",
        "MoU Universitas AMIKOM Yogyakarta dengan SMK Cyber Media dan SMK Bina Putra Jakarta",
        "Amikom Sambut 48 Orang Peserta Inbound Program Pertukaran Mahasiswa",
        "153 Calon Mahasiswa Amikom ikuti Beasiswa Program Keluarga Harapan (PKH) Kabupaten Sleman"
    )
    ...
    private val times = arrayOf(
        "10 Orang Mahasiswa Universitas Amikom Yogyakarta menerima...",
        "Mahasiswa Program Studi Ilmu Komunikasi Universitas AMIKOM Yogyakarta...",
        "Mahasiswa S1 Teknik Komputer Universitas AMIKOM Yogyakarta berhasil...",
        "UNIVERSITAS AMIKOM YOGYAKARTA, kembali menorehkan prestasi...",
        "TAIWAN — Prestasi gemilang kembali diraih oleh Prodi Sistem Informasi... ",
        "Universitas Amikom Yogyakarta mendapat kado terindah berupa keluarnya...",
        "Universitas AMIKOM Yogyakarta tahun ini akan berusia ke 29...",
        "Universitas AMIKOM Yogyakarta melakukan perpanjangan MoU...",
        "Universitas Amikom Yogyakarta menyambut kedatangan 48 Orang...",
        "Pemkab Sleman Sleman bekerjasama dengan Universitas AMIKOM...",
    )
    ...
    private val ingredient = arrayOf(
        arrayListOf(
            "10 Orang Mahasiswa Universitas Amikom Yogyakarta menerima beasiswa Sarjana dari Bank Mualamat Indonesia melalui Baitul Maal Muamalat (BMM). Total mereka mendapat Beasiswa senilai 30 Juta.",

        ),
        arrayListOf(
            "Mahasiswa Program Studi Ilmu Komunikasi Universitas AMIKOM Yogyakarta, Dwi Nur Rohim, mengikuti program Youth Abroad Expedition (YAE) #4 dengan tema Cikgu Mengajar yang diadakan pada tanggal 16-19",

        ),
        arrayListOf(
            "Mahasiswa S1 Teknik Komputer Universitas AMIKOM Yogyakarta berhasil jadi Juara 1 dalam Lomba IoT and Networking Competition (IoNIC 2023) yang diadakan oleh Prodi D4 Teknologi Rekayasa Internet.",

        ),
        arrayListOf(
            "UNIVERSITAS AMIKOM YOGYAKARTA, kembali menorehkan prestasi di Kejuaraan Nasional Taekwondo Grade-C Wali Kota Cup X 2023. Tim taekwondo AMIKOM dengan 19 anggota yang turun di kancah nasional ",

        ),
        arrayListOf(
            "TAIWAN — Prestasi gemilang kembali diraih oleh Prodi Sistem Informasi Fakultas Ilmu Komputer AMIKOM Jogja. Mereka berhasil meraih predikat BEST INNOVATION dalam lomba Innoserve 2023 Taiwan,",

        ),
        arrayListOf(
            "Universitas Amikom Yogyakarta mendapat kado terindah berupa keluarnya izin pembukaan Program Studi Informatika Program Doktoral Universitas Amikom Yogyakarta dalam Sidang Senat Terbuka ",

        ),
        arrayListOf(
            "Universitas AMIKOM Yogyakarta tahun ini akan berusia ke 29, Dalam rangka memeriahkan gelaran hari jadi kampus ungu tersebut, Amikom membuka rangkaian Dies Natalis Amikom ke 29 ",

        ),
        arrayListOf(
            "Universitas AMIKOM Yogyakarta melakukan perpanjangan MoU dengan SMK Cybermedia Jakarta dan SMK Bina Putra Jakarta (5 September 2023) di Ruang Cinema Amikom, ",

        ),
        arrayListOf(
            "Universitas Amikom Yogyakarta menyambut kedatangan 48 Orang mahasiswa Inbound Program Pertukaran Mahasiswa yang bergabung dalam Program Merdeka Belajar",

        ),
        arrayListOf(
            "Pemkab Sleman Sleman bekerjasama dengan Universitas AMIKOM Yogyakarta kembali mengadakan program beasiswa kepada Keluarga Penerima Manfaat (KPM) ",
